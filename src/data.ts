    ...
    customizations: [
      {
        ...
        options: [
          ...
          { name: 'Test Red Fiery (Sichuan Style)', price: 0 },
        ]
      }
    ]
  },
...
export const MOKAI_GALLERY_SPACES = [
  {
    id: 'space-mures',
    title: 'Experience Test Interior',
    ...
    spots: [
      { x: 25, y: 35, title: 'Experience Test Wall', txt: 'Curated signage detailing Mokai’s journey from a humble local dream to a Pune coffee sanctuary.' },
